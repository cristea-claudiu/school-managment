...
public class StudentInfoController {
    ...
    public ResponseMessage<StudentInfoResponse> update(@RequestBody @Valid UpdateStudentInfoRequest updateStudentInfoRequest, @PathVariable Long studentInfoId){
    ...
    public ResponseEntity<StudentInfoResponse> getStudentInfoById(@PathVariable Long studentInfoId){
       studentInfoService.getStudentInfoById(studentInfoId);
